        ...
        >
          {SERVICES.map((service, i) => (
            <motion.div
              ...
              className={`group relative bg-forge-card border border-forge-border rounded-xl p-6 cursor-default transition-colors duration-300 hover:border-forge-orange/40 card-glow ${
            ...
            >
              ...
              <div className="inline-flex p-3 rounded-lg bg-gradient-to-br from-orange-500 to-red-600 mb-5 group-hover:scale-110 transition-transform duration-300">
